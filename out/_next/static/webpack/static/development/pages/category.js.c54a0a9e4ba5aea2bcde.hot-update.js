...
function Category(_ref) {
  ...
  function _handleDelete() {
    ...
    /*#__PURE__*/
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(categories, id) {
      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_11___default()("http://localhost:8080/api/category?id=".concat(id), {
                method: 'DELETE'
              });
            ...
            case 5:
              ...
              if (data.errorCode) {
                ...
                rIndex = categories.findIndex(function (category) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.f, {
    title: "\u7C7B\u76EE\u7BA1\u7406",
    __source: {
    ...
    __self: this
  }, "\u7C7B\u76EE ID"), __jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_7__["default"], {
    align: "left",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 61
    ...
    __self: this
  }, "\u7C7B\u76EE\u540D\u79F0"), __jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_7__["default"], {
    align: "left",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 62
    ...
    __self: this
  }, "\u7C7B\u76EE\u6743\u91CD"), __jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_7__["default"], {
    align: "left",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 63
    ...
    return __jsx(_material_ui_core_TableRow__WEBPACK_IMPORTED_MODULE_9__["default"], {
      ...
      __self: this
    }, category._id), __jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_7__["default"], {
      align: "left",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 74
      ...
      __self: this
    }, category.name), __jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_7__["default"], {
      align: "left",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 77
      ...
      __self: this
    }, category.weight), __jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_7__["default"], {
      align: "left",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 80
      ...
      __self: this
    }, moment__WEBPACK_IMPORTED_MODULE_15___default()(category.createTime).format('lll')), __jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_7__["default"], {
      align: "left",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 83
      ...
      onClick: function onClick() {
        return handleDelete(categories, category._id);
      },
      __source: {
        fileName: _jsxFileName,
        lineNumber: 87
  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_11___default()('http://localhost:8080/api/categories');
...
//# sourceMappingURL=category.js.c54a0a9e4ba5aea2bcde.hot-update.js.map